...
/*   Updated: 2016/11/18 15:41:49 by afeuerst         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_append(t_data **object, int key, void *data);

int					ft_remove(t_data *object, int key);

int					ft_remove_data(t_data *object, void *data);

void				*ft_get(t_data *object, int key);
